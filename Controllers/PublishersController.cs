...
namespace AuthSystem.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,CompanyName,ContactEmail")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,CompanyName,ContactEmail")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
